...
export default function Calculations() {
    ...
    return <div className="p-2 max-w-3xl flex flex-col gap-2 w-full">
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5">
            ...
            {submitAttempted && !distance ? <Label htmlFor="dt" className="text-red-400">No value selected</Label> : null}
        </div>
        <div className="grid w-full max-w-sm items-center gap-1.5">
            ...
            {submitAttempted && !travelTime ? <Label htmlFor="dt" className="text-red-400">No value selected</Label> : null}
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5">
            ...
            {submitAttempted && !waitingTime ? <Label htmlFor="dt" className="text-red-400">No value selected</Label> : null}
