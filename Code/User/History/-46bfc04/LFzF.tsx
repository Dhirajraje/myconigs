...
export default function Calculations() {
    ...
    return <div className="p-2 max-w-3xl flex flex-col gap-2 w-full">
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5">
            ...
            <Input value={distance} onChange={(e:any)=>{
                setDistance(e.target.value)
            }} type="number" id="dt" placeholder="Distance Travelled" />
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5">
            ...
            <Input type="number" id="ttt" placeholder="Total Time Travelled" />
        </div>
        <div className="grid w-full max-w-sm items-center gap-1.5">
            <Label htmlFor="wt">Waiting Time (in minutes)</Label>
            <Input type="wt" id="wt" placeholder="Waiting Time" />
        </div>
        <div className="grid w-full max-w-sm items-center gap-1.5">
