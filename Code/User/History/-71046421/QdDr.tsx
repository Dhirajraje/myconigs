...
export default function AdditionalPriceConfig() {
    const query = useQuery({ queryKey: ['base-prices'], queryFn: getAdditionalPrices })
        ...
        <div className="rounded-md bg-white max-w-md w-full shadow p-4 flex flex-col">
            ...
            <div className="flex-grow overflow-visible">
                <div className="grid w-full items-center gap-1.5 p-1">
                    <Label htmlFor="base-price">Additional Price</Label>
                    ...
                    }} type="number" id="base-price" placeholder="Additional Price" />

                </div>
                <div className="grid w-full items-center gap-1.5 p-1">
                    <Label htmlFor="base-distance">Additional Distance</Label>
                    ...
                    }} type="number" id="base-distance" placeholder="Additional Distance" />
