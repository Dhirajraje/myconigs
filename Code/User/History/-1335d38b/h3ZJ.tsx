                    ...
                    <FancyMultiSelect options={dropdownItems}
                        ...
                        onSelectChange={(values: any) => {
                            setModalState({
                                ...
                                data: {
                                    ...modalState?.data ?? {},
                                    applicable_days: values.map((el: { value: any; }) => el.value)
                                }
                            })
    ...
    return <div className="absolute bg-slate-500/30 top-0 p-2 left-0 h-screen w-screen flex justify-center items-center">
        <div className="rounded-md bg-white max-w-md w-full shadow p-4 flex flex-col">
            ...
            <div className="flex-grow overflow-visible">
                ...
                <>
                    {
                        query.data?.data.data.map((el: { created_by: { username: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | null | undefined; }; created_on: string; }, index: Key | null | undefined) => {
