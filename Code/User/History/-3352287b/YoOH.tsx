import { ArrowUpTrayIcon, BanknotesIcon, CalculatorIcon, CircleStackIcon, ClockIcon, CloudIcon } from "@heroicons/react/24/solid"
...
export default function HomeWrap() {
    ...
    },
    {
        ...
        icon:<ArrowUpTrayIcon className="w-5 h-5 text-current" />
    },
    {
        name:"Waiting Charges Configs",
        path:"/home/waiting-charges-configs",
        icon:<CloudIcon className="w-5 h-5 text-current" />
    }]
